...
plot_states_by_history(means["simulation"], connection_range_percentage=0.20, variability=10.0, stdevs_data=None, show_legend=False)
# Example usage: plot for specific connection_range and variability
...
plot_legend_only_for_history(means["simulation"], connection_range_percentage=0.20, variability=10.0)

# Example usage: plot comparing variabilities (first 4 state vars)
plot_states_by_variability(means["simulation"], connection_range_percentage=0.20, stdevs_data=None, state_vars_to_show=4)
